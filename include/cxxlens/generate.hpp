...
/** @file generate.hpp @brief Stable generation, mock, harness, copy, and fuzz declarations. */
...
namespace cxxlens::generate
{
	...
	class generation_plan
	{
	  public:
		...
		[[nodiscard]] std::span<const unresolved> unresolved_items() const noexcept;
		[[nodiscard]] const coverage_report& coverage() const noexcept;
		[[nodiscard]] result<std::string> preview(std::size_t output_budget_bytes = 4 * 1024 *
													  1024) const;
		[[nodiscard]] std::string to_json() const;
		[[nodiscard]] std::string to_markdown() const;
		[[nodiscard]] result<generation_result>
	...
	namespace mock
	{
		...
		class generator
		{
		  public:
			...
			[[nodiscard]] result<generation_plan> plan(workspace& workspace,
													   execution_context execution = {}) const;
	...
	namespace method_harness
	{
		...
		[[nodiscard]] result<method_resolution> resolve_method(const workspace& workspace,
		...
		class generator
		{
		  public:
			...
			[[nodiscard]] result<method_inspection> inspect(const workspace& workspace,
															execution_context execution = {}) const;
			[[nodiscard]] result<generation_plan> plan(workspace& workspace,
													   execution_context execution = {}) const;
	...
	namespace copy
	{
		...
		[[nodiscard]] result<generation_plan> public_surface(workspace& workspace,
															 select::symbol_selector target,
															 copy_options options = {},
															 execution_context execution = {});
		[[nodiscard]] result<generation_plan> required_types(workspace& workspace,
