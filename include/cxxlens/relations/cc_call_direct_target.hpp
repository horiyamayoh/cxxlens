	...
	struct call_direct_target
	{
		...
		[[nodiscard]] static const sdk::relation_descriptor& descriptor()
		{
			static const sdk::relation_descriptor value = []
			{
				...
				output.descriptor_digest = "sha256:da739526eb4cabacb982550b61014187d293eef5ea31e03914abcb60acd16f0c";
				return output;
			}();
			return value;
		}
