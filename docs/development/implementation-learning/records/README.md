...
| [DF-0182](df-0182-clang22-installed-output-adoption.md) | investigating | blocked | `provider.clang22-installed-task`, `provider.validated-output-adoption`, `release.clang22-vertical-evidence` | Define the installed Clang 22 task and validated output adoption boundary |
