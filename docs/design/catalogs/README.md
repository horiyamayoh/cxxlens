...
| Provider Runtime | `schemas/cxxlens_ng_provider_runtime_contract.yaml` | #150 | implemented exact contract |
...
| Security Profile | `schemas/cxxlens_ng_security_profile.yaml` | #150 | accepted exact contract |
