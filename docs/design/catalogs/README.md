...
| SQLite Physical Store | `schemas/cxxlens_ng_sqlite_store_contract.yaml` | #68 / #181 / #200 / #205 | v2 implemented; Option A v3 user-selected and DF-0205 authenticated SHM lease proposal pending independent acceptance |
