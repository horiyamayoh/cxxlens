...
| SQLite Physical Store | `schemas/cxxlens_ng_sqlite_store_contract.yaml` | #68 / #181 / #200 / #205 | v2 implemented; Option A v3 user-selected; DF-0205 authenticated SHM lease authority accepted at `6cb705c256c9576f74b50a2dca8fc4e8f72d06bb`, with internal implementation pending and production blocked until exact implementation/matrix review |
...
| Clang 22 Installed Materialization | `schemas/cxxlens_ng_clang22_materialization_contract.yaml` | #181 / #205 | accepted option-2 boundary with DF-0191/DF-0192/DF-0194 and DF-0195–DF-0199 amendments; DF-0200 blocks claim/Store orchestration, detailed reporting, and scale qualification, and accepted DF-0205 authority still blocks same-process Store CAS/race activation pending exact implementation/matrix review, while the independent streaming/runtime foundation continues under #181 |
