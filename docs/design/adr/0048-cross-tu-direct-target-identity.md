...
> Amendment: ADR 0050 replaces the provider-local `entity_identity` formula below
...
>
> Amendment: ADR 0083 removes declaration/definition occurrence anchor from the
