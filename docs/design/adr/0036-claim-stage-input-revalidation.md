...
- ADR 0109 の schema-equivalent text validation error も変換せず、builder/aggregate/stage constructorで同じ categoryを返す。
...
ADR 0109 の UTF-8/control/max-length field mutation も同じ revalidation matrixへ含める。
