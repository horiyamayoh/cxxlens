...
| API-EXP-002 | explain | <cxxlens/explain.hpp> | explain::why_not_matched | AU-EXP-002 | conformant |
...
| API-SRCH-003 | search | <cxxlens/search.hpp> | search::calls | AU-SRCH-003 | conformant |
| API-SRCH-004 | search | <cxxlens/search.hpp> | search::calls_to_function | AU-SRCH-004 | conformant |
| API-SRCH-005 | search | <cxxlens/search.hpp> | search::calls_to_method | AU-SRCH-005 | conformant |
| API-SRCH-006 | search | <cxxlens/search.hpp> | search::inheritance | AU-SRCH-006 | conformant |
| API-SRCH-007 | search | <cxxlens/search.hpp> | search::overrides | AU-SRCH-007 | conformant |
