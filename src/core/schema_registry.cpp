		...
		: entries_{
			  descriptor("cxxlens.analysis-scope.v1",
						 {"compile_units",
						  ...
						  "semantics_version",
						  "variants"}),
			  descriptor("cxxlens.agent-task-card.v1",
						 {"api_calls",
						  "expected_outputs",
						  "failure_modes",
						  "goal",
						  ...
						  "semantics_version",
						  "verification_steps"}),
			  descriptor("cxxlens.capabilities.v1",
						 {"capabilities", "library_version", "schema", "semantics_version"}),
			  descriptor(
			  ...
			  descriptor("cxxlens.coverage-delta.v1",
						 {"covered",
						  "failed",
						  "library_version",
						  "requested",
			  ...
			  descriptor("cxxlens.explanation.v1",
						 {"evidence",
						  "library_version",
						  "properties",
						  "schema",
						  ...
						  "title",
						  "unresolved"}),
			  descriptor("cxxlens.fact-profile.v1",
						 {"kinds", "library_version", "precision", "schema", "semantics_version"}),
			  descriptor("cxxlens.fact-requirement.v1",
						 {"compile_unit",
						  "fact_kind",
						  "file",
						  "input_digest",
						  ...
						  "semantics_version",
						  "variant"}),
			  descriptor("cxxlens.fact.v1",
						 {"id", "kind", "payload", "provenance", "schema", "stable_key"},
						 {"call", "name_identity", "source", "type_identity"}),
			  ...
			  descriptor("cxxlens.frontend-batch.v1",
						 {"adapter",
						  "compile_unit_id",
						  "coverage",
						  "diagnostics",
			  ...
			  descriptor("cxxlens.selector.v1",
						 {"domain",
						  "expression",
						  "library_version",
						  ...
						  "schema",
						  "semantics_version"}),
			  descriptor("cxxlens.search-report.v1",
						 {"accounting",
						  "coverage",
						  "guarantee",
						  "library_version",
			  ...
			  descriptor("cxxlens.testing.fixture.v1",
						 {"arguments",
						  ...
						  "target",
						  "variants"}),
			  descriptor("cxxlens.observation.v1",
						 {"adapter",
						  "compile_unit_id",
						  ...
						  "schema",
						  "variant_id"},
						 {"name_identity", "source", "type_identity"}),
			  descriptor("cxxlens.provisioning-trace.v1",
						 {"covered",
						  "failed",
						  "library_version",
						  "requested",
			  ...
			  descriptor(
				  ...
				  {"diagnostics", "healthy", "library_version", "schema", "semantics_version"}),
		  }
	{
