	...
	namespace
	{
		...
		[[nodiscard]] result<void> validate_literal_value(const ir_literal& literal)
		{
			static const std::map<std::string, scalar_kind, std::less<>> names{
				...
				{"relation_name", scalar_kind::relation_name},
				{"semantic_key_id", scalar_kind::semantic_key_id},
				{"assertion_id", scalar_kind::assertion_id},
				{"content_digest", scalar_kind::content_digest},
				{"interpretation_domain_id", scalar_kind::interpretation_domain_id},
