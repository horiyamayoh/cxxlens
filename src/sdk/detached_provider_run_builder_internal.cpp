...
namespace cxxlens::sdk::detail
{
								...
								const import_limits limits)
	{
		try
		{
			...
			draft.task_id = request.task_id;
			draft.task_input_digest = request.task_input_digest;
			draft.replay_plan_digest = std::move(replay_plan_digest);
			draft.provider = {candidate.description.provider_id,
