...
namespace cxxlens::sdk::provider
{
	...
	{
		class vector_input final : public detail::replayable_host_input
		{
		  public:
										...
										const std::span<std::byte> output) const override
			{
				if (offset > bytes_.size())
					return cxxlens::sdk::unexpected(provider_error(
						"provider.host-transcript-invalid", "payload", "read-offset"));
		...
		class vector_frame_sink final : public frame_sink
		{
		  public:
	...
	{
		class vector_chunk_sink final : public detail::host_input_chunk_sink
		{
		  public:
