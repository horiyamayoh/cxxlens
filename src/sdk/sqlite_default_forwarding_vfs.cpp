...
namespace cxxlens::sdk
{
	...
	namespace
	{
		...
		// The native-OK exception is reachable only through the qualified active-WAL source
		// profile below. Every map still requires the nested lease, exact retained-object receipt,
		// namespace recheck, zero-effect terminal, and per-map projection receipt; any missing
		// receipt remains an IOERR/quarantine path.
