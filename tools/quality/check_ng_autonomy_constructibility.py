...
def validate(root: pathlib.Path) -> dict[str, Any]:
    ...
    require_exact(
        mapping["contract_ids"],
        {
            "active_read": "store.sqlite-active-read-connection.v1",
            "writer_generation": "cxxlens.sqlite.same-process-writer-shm-mapping-lease.v1",
            "reader_attachment": "cxxlens.sqlite.reader-shm-native-attachment.v1",
            "nested_mapping_terminal": "cxxlens.sqlite-nested-mapping-terminal.v1",
            "logical_read": "store.sqlite-logical-read-receipt.v1",
        },
        "SQLite contract ownership",
    )
    ...
    require_exact(
        mapping["outer_effect_boundary"],
        {
            "outer_receipt": "outer-read-zero-effect-receipt",
            "writer_effect_disposition": "writer-effect-never-satisfies-outer-zero-effect-or-logical-read-receipt",
            "writer_terminal_disposition": "writer-terminal-is-audit-only-until-outer-zero-effect-census-proves-no-writer-effect",
        },
        "SQLite outer effect boundary",
    )
