...
LEGACY_OWNERSHIP_SCHEMA_EXCLUSIONS = {
    ...
    "cxxlens_ng_provider_execution_report.schema.yaml",
    "cxxlens_ng_provider_manifest.schema.yaml",
    "cxxlens_ng_provider_protocol.schema.yaml",
    "cxxlens_ng_provider_runtime_contract.schema.yaml",
    ...
    "cxxlens_ng_provider_support_matrix.schema.yaml",
    "cxxlens_ng_security_conformance_report.schema.yaml",
    "cxxlens_ng_security_conformance_vectors.schema.yaml",
