        ...
        assignment.update(
            {
                "gap": {
                    ...
                    "remediation": (
                        ...
                        "writer-mapping and writer-native-attachment authorities plus the "
                        "accepted DF-0208 typed determinate gate-failure evidence authority; "
                        "resolve and implement the blocking DF-0207 reader-native-attachment "
                        "authority before qualifying the full "
