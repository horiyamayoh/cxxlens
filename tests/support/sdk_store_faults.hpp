...
namespace cxxlens::sdk
{
	...
	[[nodiscard]] result<void> rewrite_publication_payload_schema_for_testing(
		snapshot_store& store, std::string_view publication_id, std::uint8_t payload_version);
	[[nodiscard]] result<void> rewrite_publication_identity_field_for_testing(
		snapshot_store& store, std::string_view publication_id, std::string_view field);
	...
	[[nodiscard]] result<void> poison_rejected_generation_for_testing(
		snapshot_store& store, std::string_view publication_id, std::uint64_t generation);
} // namespace cxxlens::sdk
